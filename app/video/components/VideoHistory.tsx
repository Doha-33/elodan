...
export function VideoHistory({
  ...
  return (
    <div className="h-full overflow-y-auto bg-[#F1F1F1] px-6 font-[Inter] space-y-4 scroll-smooth elegant-scroll">
          ...
          <div className="bg-white border border-[#E5E5E8] rounded-2xl p-6 shadow-sm">
            ...
            <div className="mb-6">
              <div className="flex items-start justify-between gap-10 mb-5">
                <p className="text-[15px] text-[#110C0C] font-bold flex-1 leading-relaxed truncate max-w-[350px]">
                  {gen.prompt}
                </p>
                <div className="flex items-center gap-2 flex-shrink-0">
                  <span className="px-3 py-1 bg-[#F1F1F1] border border-gray rounded text-[11px] text-[#110C0C] tracking-tighter">
                    {gen.model}
                  </span>
                  <span className="px-3 py-1 bg-[#F1F1F1] border border-gray rounded text-[11px] text-[#110C0C] tracking-tighter">
                    {gen.duration}
                  </span>
                  <span className="px-3 py-1 bg-[#F1F1F1] border border-gray rounded text-[11px] text-[#110C0C] flex items-center gap-2 tracking-tighter">
                    <div className="w-3 h-2 border border-[#110C0C] rounded-sm opacity-40" />{" "}
                    {gen.ratio}
                  </span>
                </div>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <RefreshCw
                  className={`w-4 h-4 opacity-60 ${gen.isLoading ? "animate-spin" : ""}`}
                />
                Regenerate
              </button>
              <button
